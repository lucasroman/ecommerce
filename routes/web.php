...
// Chat Get
Route::get('/service/{service}/chats', function(Service $service) {
    return view('profile.chat', ['service' => $service]);
})->middleware(['auth', 'verified'])->name('chat');

// Chat Post
Route::post('/service/{service}/chat', [ChatController::class, 'store']);
